...
export default function Home() {
  ...
  return (
    <div className="space-y-8">
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg p-6 shadow mb-8">
        <h2 className="text-2xl font-bold">Welcome to AI-PrescripSafe</h2>
